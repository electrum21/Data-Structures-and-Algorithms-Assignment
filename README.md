...
This assignment was done as part of Nanyang Polytechnic (NYP) IT2553 Data Structure and Algorithms module.

### Project Background
The purpose of the Medicine Inventory System is to allow a pharmaceutical company to manage the Medicine Inventory in the Pharmacy.  
They can display, add, update and remove medicine record from the inventory, perform searching and sorting of records, and other additional features that improve the usefulness of the application for the user.

**Medicine Inventory – Basic Features**
...
**Medicine Inventory – Search and Sort Algorithms**
